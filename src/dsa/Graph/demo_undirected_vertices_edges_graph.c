...
#include "lib/undirected_graph/vertices_edges_graph.h"
#include <assert.h>
#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
    printf(
        "** Undirected graph :: Implement using vertices-edges matrix **\n\n");
...
void test_get_adjacents(Graph g) {
    int neighbor_of_1[3] = {2, 3, 5};
    int neighbor_of_2[3] = {1, 4, 5};
    int neighbor_of_3[3] = {1, 4, 5};
    int neighbor_of_4[3] = {2, 3, 5};
    int neighbor_of_5[4] = {1, 2, 3, 4};
...
void test_dfs(Graph g) {
    ...
    int dfs_2[5] = {2, 1, 3, 4, 5};
    int dfs_3[5] = {3, 1, 2, 4, 5};
    int dfs_4[5] = {4, 2, 1, 3, 5};
    int dfs_5[5] = {5, 1, 2, 4, 3};
...
void test_dfs_using_stack(Graph g) {
    int dfs_1[5] = {1, 5, 4, 3, 2};
    int dfs_2[5] = {2, 5, 4, 3, 1};
    int dfs_3[5] = {3, 5, 4, 2, 1};
    int dfs_4[5] = {4, 5, 3, 1, 2};
    int dfs_5[5] = {5, 4, 3, 1, 2};
...
void test_bfs_using_queue(Graph g) {
    int dfs_1[5] = {1, 2, 3, 5, 4};
    int dfs_2[5] = {2, 1, 4, 5, 3};
    int dfs_3[5] = {3, 1, 4, 5, 2};
    int dfs_4[5] = {4, 2, 3, 5, 1};
    int dfs_5[5] = {5, 1, 2, 3, 4};
